import{a as y,S as g,i as c}from"./assets/vendor-D3PmPE7A.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function a(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(t){if(t.ep)return;t.ep=!0;const r=a(t);fetch(t.href,r)}})();const f="https://pixabay.com/api/",b="48265594-3edacf02e8cadda91195713cc";async function u(s,e=1){const a=`${f}?key=${b}&q=${encodeURIComponent(s)}&image_type=photo&orientation=horizontal&safesearch=true&per_page=15&page=${e}`;try{return(await y.get(a)).data}catch{throw new Error("Sorry, there are no imagies matching your search query. Please try again!")}}const v=new g(".gallery a",{captionsData:"alt",captionDelay:200});function w({webformatURL:s,largeImageURL:e,tags:a,likes:n,views:t,comments:r,downloads:i}){return`
    <div class="card">
